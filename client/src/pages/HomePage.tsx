...
const HomePage: React.FC = () => {
  ...
  const isActiveCamera = jobReducer.job.camera1_is_active || jobReducer.job.camera2_is_active || jobReducer.job.camera3_is_active
  ...
  return (
    <div>
      ...
      {isActiveCamera ? <Result report={last_report} /> : <p style={{marginTop: "4em"}}>Нет активных камер</p>}
