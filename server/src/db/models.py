...
class Report(BaseModel):
    ...
    сut_fact_volume_delta_1 = Column(Float, nullable=True)
    сut_fact_volume_delta_2 = Column(Float, nullable=True)
    сut_fact_volume_delta_3 = Column(Float, nullable=True)
